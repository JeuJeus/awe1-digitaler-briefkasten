...
Zuerst ist der Login sowie die Registrierung abgesichert. Nutzer müssen ein Passwort mit mindestens 8 Zeichen wählen, welches im Backend inklusive Salt und gehashed gespeichert wird. Hierzu benutzen wir BCrypt als Passwort Encoder. Diesen verwenden wir mit einer Stärke von 10, das bietet für uns die beste Balance zwischen Sicherheit und Performance. Mit dem Login bekommen Nutzer einen Cookie, in Form einer JSession ID, mit dem sie sich in weiteren Requests authentifizieren und über den sie identifiziert werden können.\\
